...
void showInventory(Node* head, Node* tail){
    ...
    while(temp != nullptr){
        cout << index << ". ID Item: " << temp->item.id << endl;
        cout << "   Nama Item: " << temp->item.namaItem << endl;
...
void showInventoryTranversal(Node* head, Node* tail){
    if(head == nullptr){
        cout << "Inventory kosong." << endl;
        return;
    }
...
void showDetailData(Node* head, Node* tail, int id=-1, string nama=""){
    if(head == nullptr){
        cout << "Inventory kosong." << endl;
        return;
    }
    ...
    Node* temp = head;
    if (id != -1) {
        while (temp != nullptr && temp->item.id != id) {
            temp = temp->next;
        }
    }
    else if (!nama.empty()) {
        while (temp != nullptr && temp->item.namaItem != nama) {
            temp = temp->next;
        }
    }
    ...
    cout << "\nDetail Item:\n";
    cout << "ID Item: " << temp->item.id << endl;
    cout << "Nama Item: " << temp->item.namaItem << endl;
    cout << "Jumlah: " << temp->item.jumlah << endl;
    cout << "Tipe: " << temp->item.type << endl;
};
...
int main(){
    ...
    while(pilihan != 0){
        ...
        cout << "| 6. Tampilkan Inventory Tranversal                 |\n";
        cout << "| 7. Tampilkan Detail Data                          |\n";
        cout << "| 0. Keluar                                         |\n";
        cout << "+---------------------------------------------------+\n";
        cout << "Pilih menu: ";
        cin >> pilihan;
        ...
        switch(pilihan) {
            ...
            case 5:
                ...
                break;
            case 6:
                showInventoryTranversal(head, tail);
                break;
            case 7:
                cout << "Cari berdasarkan nama item atau id item? \n(1 untuk id, 2 untuk nama): ";
                int subPilihan;
                cin >> subPilihan;
                ...
                {   
                    ...
                    cin >> id;
                    showDetailData(head, tail, id, "");
                }else if(subPilihan == 2){
                    string nama;
                    cout << "Masukkan nama item: ";
                    cin.ignore();
                    getline(cin, nama);
                    showDetailData(head, tail, -1, nama);
                }else{
